          ...
          <nav className="p-5 space-y-6 mt-12">
            ...
            {!loading && (
              user ? (
                <Link 
                  href="/profile" 
                  className="flex items-center gap-2 px-6 py-3 bg-[#090909] border border-[#007AFF] rounded-[32px] text-white uppercase text-base shadow-[inset_1px_-1px_4.5px_0px_rgba(255,255,255,0.1)] hover:bg-[#007AFF]/10 hover:text-[#FBB04C] hover:border-[#FBB04C] transition-all duration-300"
                  onClick={() => setIsOpen(false)}
                >
                  {/* <span>My Profile</span>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
