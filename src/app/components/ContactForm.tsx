...
export default function ContactForm() {
  ...
  return (
    <div className='container odr-course-bg ellipse-bg py-15 px-15 flex flex-col items-center gap-9.5 justify-center mt-30 max-sm:mt-10  mx-auto max-sm:px-5 max-sm:py-10'>
    <div>
