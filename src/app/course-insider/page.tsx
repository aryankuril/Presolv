  ...
  return (
    <main className="bg-black text-white min-h-screen">
      ...
      <CourseModules modules={modules} title="Inside The Course" />
        ...
        <div className="container  odr-course-bg ellipse-bg grid grid-cols-2 gap-10 mx-auto py-15 px-15 mt-20 max-sm:mt-10 max-sm:grid-cols-1 max-sm:px-5 max-sm:py-5 max-sm:gap-3">
      ...
      <div className='container  relative grid grid-cols-2 px-50 py-10 gap-10 mt-20 max-sm:mt-10 max-sm:grid-cols-1 mb-10 mx-auto max-sm:px-5 max-sm:py-10'>
