            ...
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-8">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full min-w-[420px] bg-[#4285F4] text-white rounded-full py-4 px-6 flex items-center justify-center gap-2 hover:bg-[#4285F4]/90 text-[14px] font-medium mt-8"
                >
                  {isLoading ? (
...
<image id="image0_902_4" width="100" height="100" preserveAspectRatio="none" href="data:image/png;base64,"/>
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full min-w-[420px] bg-[#4285F4] text-white rounded-full py-8 px-10 flex items-center justify-center gap-2 hover:bg-[#4285F4]/90 text-[18px] font-medium mt-8 h-[60px]"
                >
                  {isLoading ? (
                    <span className="flex items-center gap-2">
